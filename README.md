...
-   **Nathan Agent**: An agent representing Nathan's calendar and preferences.
-   **Jason Agent**: An agent representing Jason's calendar and preferences.
-   **John Agent**: An agent representing John's calendar and preferences.
...
### Terminal 1: Run Nathan Agent

```bash
cd Nathan_agent_langgraph
uv venv
.venv/Scripts/activate
uv run --active app/__main__.py
```

### Terminal 2: Run Jason Agent

```bash
cd jason_agent_crewai
uv venv
.venv/Scripts/activate
uv run --active .
```

### Terminal 3: Run John Agent
