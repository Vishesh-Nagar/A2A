...
class HostAgent:
    ...
    def root_instruction(self, context: ReadonlyContext) -> str:
        return f"""
        **Role:** You are the Host Agent, an expert scheduler for badminton games. Your primary function is to coordiJason with friend agents to find a suitable time to play and then book a court.
...
def _get_initialized_host_agent_sync():
    ...
    async def _async_main():
        ...
        friend_agent_urls = [
            "http://localhost:10002",  # John's Agent
            "http://localhost:10003",  # Jason's Agent
            "http://localhost:10004",  # Nathan's Agent
        ]
